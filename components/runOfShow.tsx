    ...
    return (
        <div className="min-h-screen bg-background text-white p-8" id='runOfShow'>
            <div className="max-w-6xl mx-auto">
                <h2 className={`text-3xl md:text-5xl  mb-4 ${Hacked_KerX.className} flex justify-center items-center mb-8`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-[#161B22] rounded-lg p-6 border border-red-500/20">
                        <h2 className="text-3xl font-bold mb-8 text-center text-red-500">DAY 1</h2>
                    ...
                    {/* Day 2 */}
                    <div className="bg-[#161B22] rounded-lg p-6 border border-red-500/20">
                        <h2 className="text-3xl font-bold mb-8 text-center text-red-500">DAY 2</h2>
                    ...
                    {/* Day 3 */}
                    <div className="bg-[#161B22] rounded-lg p-6 border border-red-500/20">
                        <h2 className="text-3xl font-bold mb-8 text-center text-red-500">DAY 3</h2>
...
function TimeSlot({ name, time, location, highlight = false }: TimeSlotProps) {
    return (
        <div className={`rounded-lg p-4 transition-all duration-300 hover:scale-[1.02] ${highlight ? 'bg-red-500/10 border border-red-500/30' : 'bg-[#1F2937]/30'
            }`}>
