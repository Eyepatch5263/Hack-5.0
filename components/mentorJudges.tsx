...
function PersonCard({ person }: { person: Person }) {
  return (
    <div className="group relative bg-dark-light/50 rounded-xl overflow-hidden transform transition-all duration-300 hover:-translate-y-2">
    ...
    <div className="">
      ...
      <div
        className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 ${
          people.length === 2 ? "lg:grid-cols-4" : ""
        }`}
      >
