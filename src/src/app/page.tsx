        ...
        <div className="relative container mx-auto px-6 py-16">
          ...
          <nav className="flex justify-between items-center mb-16">
            ...
            <div className="flex space-x-8">
              <button className="hover:text-indian-tan transition-colors">About</button>
              <button className="hover:text-indian-tan transition-colors">Schedule</button>
              <button className="hover:text-indian-tan transition-colors">Sponsors</button>
          ...
          <div className="flex items-center justify-between mt-24">
            <div className="max-w-2xl">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Embark on an epic journey of innovation and creativity. Join us in forging the future
                through code, collaboration, and cutting-edge technology.
              </p>
