...
const Landing = () => {
    return (
        <div className="relative min-h-screen snap-start overflow-hidden bg-gradient-to-b from-gray-500 to bg-black">
            <ParticlesBackground />
                    ...
                    <div className="relative container mx-auto px-6 py-16">
                        ...
                        <div className="flex items-center justify-between mt-24">
                            <div className="max-w-2xl">
                                ...
                                <p className="md:text-2xl text-gray-300 mb-8">
                                ...
                                <div className="absolute inset-0 floating">
                                    <div className="relative w-full h-full">
                                        ...
                                        <div className="absolute inset-0 flex items-center justify-center">
                                            <Zap className="w-64 h-64 glowing" />
                                        </div>
                                    </div>
                                </div>
                            </div>
