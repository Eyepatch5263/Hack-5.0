...
const Sponsors = () => {
    return (
        <div className="px-16 bg-gradient-to-br from-gray-600 via-slate-900 to bg-amber-900">
            ...
            <div className="mb-16">
                <div className="flex items-center justify-center gap-2 mb-8">
                    <Diamond className="w-6 h-6 text-tango" />
                    <h3 className="text-2xl text font-semibold">Platinum Partners</h3>
                </div>
            ...
            <div className="mb-16">
                <div className="flex items-center justify-center gap-2 mb-8">
                    <Award className="w-6 h-6 text-indian-tan" />
