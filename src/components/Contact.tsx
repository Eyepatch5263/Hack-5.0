...
const Contact = () => {
    ...
    return (
        <div className="snap-start pt-16 relative bg-gradient-to-br from-gray-900 to-amber-900/90 opacity-90">
            ...
            <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
                ...
                <div className="space-y-6 mb-10">
                    <div className="bg-sepia-black/50 rounded-xl p-8 text-center border border-tango/20 hover:border-tango/40 transition-colors">
                        ...
                        <p className="text-gray-200 mb-4">Questions? Drop us a line</p>
                    ...
                    <div className="bg-sepia-black/50 rounded-xl p-8 text-center border border-tango/20 hover:border-tango/40 transition-colors">
                        ...
                        <p className="text-gray-200 mb-4">Join us at the venue</p>
                    ...
                    <div className="bg-sepia-black/50  mb-10 rounded-xl p-8 text-center border border-tango/20 hover:border-tango/40 transition-colors">
                        ...
                        <p className="text-gray-200 mb-4">Mon-Fri, 9am-5pm</p>
